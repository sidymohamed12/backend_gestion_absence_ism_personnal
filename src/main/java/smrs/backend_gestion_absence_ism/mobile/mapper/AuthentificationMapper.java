...
public interface AuthentificationMapper {
    ...
    AuthentificationMapper INSTANCE = Mappers.getMapper(AuthentificationMapper.class);
    ...
    @Mapping(target = "absences", ignore = true)
    @Mapping(target = "classe", ignore = true)
    UtilisateurMobileDto utilisateurToUtilisateurMobileDto(Utilisateur utilisateur);
